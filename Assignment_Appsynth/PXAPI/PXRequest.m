...
+(PXRequest *)forPhotosOfCategory:(PXPhotoModelCategory)includedCategory page:(NSInteger)page photoSizes:(PXPhotoModelSize)photoSizesMask completion:(PXRequestCompletionBlock)completionBlock {
    if (!self.apiHelper)
    {
    ...
    NSURLRequest *urlRequest = [self.apiHelper urlRequestForPhotoPage:page photoSizes:photoSizesMask only:includedCategory];
